ActiveAdmin.register CustomSite do
  ...
  permit_params :name, :url, :company_name, :city, :state, :zip_code, :primary_color, :secondary_color, :link_color, :link_color_hover, :club_name, :bank_website, :template, :account_number, :logo, :login_code, :content_section_id
  ...
  form do |f|
    ...
    f.inputs "Site Design" do
      ...
      f.input :content_section_id, as: :select, collection: ContentSection.all
